...
"""
./trimN4/RmBarcode/sample/EZHsh2.fq 4352 1088
./trimN4/RmBarcode/sample/control.fq 3380 845
./trimN4/RmBarcode/sample/EZHsh1.fq 4084 1021
./trimN4/RmBarcode/sample/FBL.fq 3568 892

total line number in file: 20000
total records: 5000
total matched lines: 15384
total matched records: 3846

 fastx_clipper -v -a ATCGTAGATC -c -i sample.fq -o ./clipper/sample_clip.fq   #2038
 fastx_clipper -v -a GATCAAGATC -c -i sample.fq -o ./clipper/sample_fbl_clip.fq  #4301 reads.


 diff /archive2/tmhyxb9/FBL/fastq/trimN4/clipper/sample_clip.fq /archive2/tmhyxb9/FBL/fastq/trimN4/RmBarcode/sample/control.fq > diff.fq
"""
